...
- Download from the [GitHub Releases](https://github.com/midy177/trzsz-go/releases), unzip and add to `PATH` environment.
...
Want to write your own ssh client that supports trzsz? Please check the [go ssh client example](https://github.com/midy177/trzsz-go/blob/main/examples/ssh_client.go).
...
Feel free to email the author <lonnywong@qq.com>, or create an [issue](https://github.com/midy177/trzsz-go/issues). Welcome to join the QQ group: 318578930.
